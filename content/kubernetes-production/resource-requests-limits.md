...
edges:
  ...
  to:
    - id: "hpa-vpa"
      ...
      detail: "My requests and limits are set and scheduling is working. But my traffic is unpredictable — sometimes I need 2 replicas, sometimes 20. I don't want to pre-provision for peak if I'm paying for idle capacity most of the time."
    - id: "health-checks-k8s"
      ...
      detail: "I've set my resource requests so the scheduler can place pods. But a pod could be Running while my app is still initializing or silently broken. How does Kubernetes know the difference between a pod that's started and one that's actually ready?"
difficulty: 3
