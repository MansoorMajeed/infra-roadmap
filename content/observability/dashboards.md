...
edges:
  to:
    - id: alerting
      ...
      detail: >-
        Dashboards require someone to look at them. Alerts are dashboards that
        look at themselves — they evaluate conditions continuously and notify
        you when something breaks. Good dashboards and good alerts go together:
        the dashboard helps you diagnose, the alert tells you to look.
difficulty: 1
tags:
  - grafana
  - dashboards
